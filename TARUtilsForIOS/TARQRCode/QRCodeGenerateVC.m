...
#pragma mark - - - 模仿支付宝二维码样式（添加用户头像）
    ...
    borderView.layer.contents = (id)[UIImage imageNamed:@"LOGO_YouJia_New"].CGImage;
...
- (void)setupGenerate_Icon_QRCode {
    ...
    imageView.image = [SGQRCodeManager SG_generateWithLogoQRCodeData:@"https://github.com/kingsic" logoImageName:@"LOGO_YouJia_New" logoScaleToSuperView:scale];
