...
-(void)setSearchImageView
{
    ...
    _searchImageView = [[UIImageView alloc] initWithFrame:CGRectMake((searchBGView.width-searchImageView_W_H)/2.0, (searchBGView.height-searchImageView_W_H)/2.0, searchImageView_W_H, searchImageView_W_H)];
    //        _searchImageView.image = [UIImage imageNamed:@"searchbar_textfield_search_icon"];
    _searchImageView.image = [UIImage imageNamed:@"home_Pay_mechanism_search_ic"];
    // contentMode：default is UIViewContentModeScaleToFill，要设置为UIViewContentModeCenter：使图片居中，防止图片填充整个imageView
    //        searchIcon.contentMode = UIViewContentModeCenter;
    [searchBGView addSubview:_searchImageView];
